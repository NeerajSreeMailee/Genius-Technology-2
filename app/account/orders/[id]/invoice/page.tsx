...
export default function OrderInvoicePage({ params }: { params: { id: string } }) {
  ...
  const downloadInvoice = async () => {
    ...
    try {
      ...
      // Reset button text
      if (downloadBtn) {
        downloadBtn.innerHTML = '<svg class="h-4 w-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path></svg> Download Invoice'
      }
    } catch (error) {
      ...
      <div className="container mx-auto px-4 py-8 print:p-0">
        ...
        <div className="mb-6 flex justify-end print:hidden">
          <div className="flex space-x-2">
            ...
            <Button id="download-invoice-btn" variant="outline" onClick={downloadInvoice}>
        ...
        {/* Invoice Content */}
        <div ref={invoiceRef} className="bg-white p-8 rounded-lg shadow-sm print:shadow-none print:p-0">
          {/* Invoice Header */}
          <div className="border-b pb-6 mb-6 print:border-b-0 print:pb-4 print:mb-4">
            <div className="flex justify-between items-start">
              ...
              <div className="text-right">
                <h2 className="text-xl font-bold text-gray-900">Genius Technology</h2>
                <p className="text-gray-600">123 Business Street</p>
                <p className="text-gray-600">Mumbai, Maharashtra 400001</p>
                <p className="text-gray-600">India</p>
                <p className="text-gray-600 mt-2">GSTIN: 12ABCDE1234PZ</p>
              </div>
            </div>
          </div>

          {/* Invoice Details */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6 print:gap-4 print:mb-4">
            <div>
            ...
            <div>
              ...
              <div className="space-y-1">
                ...
                <p className="flex justify-between">
                  ...
                  <span>INV-{order?.id?.slice(-8)}</span>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="ml-auto max-w-xs">
            <div className="space-y-2">
              ...
              <div className="flex justify-between">
                ...
                <span>{formatCurrency((order?.total || 0) * 0.18)}</span>
              </div>
              <Separator />
              <div className="flex justify-between text-lg font-bold">
                <span>Total:</span>
                <span>{formatCurrency((order?.total || 0) * 1.18)}</span>
              </div>
